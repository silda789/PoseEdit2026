...
namespace PoseEdit2026
{
    public static class RoutineCommands
    {
        ...
        //      выставляется в 20 - расчёт под требование "везде 3.0мм на бумаге", см.
        ...
        public static void FixStandardTemplateLayersAndStyleCommand()
        {
            ...
            // ВАЖНО (обновлено 2026-08-22 - пользователь сначала попросил 2.5мм на бумаге,
            // затем уточнил на 3.0мм: "давай высоту всех шрифтов не 2.5, а 3.0 сделаем
            // везде"). Высота A-F атрибутов внутри шаблона - НЕЗАВИСИМОЕ от масштаба чертежа
            ...
            // ОСНОВНОЙ таблицы теперь рисуется с высотой yzy2 = olcek*0.30 (см.
            // QuantityTableGenerator.cs, тот же коммит - пересчитано под 3.0мм на бумаге).
            ...
            // templateHeight * 0.015 == 0.30 => templateHeight == 20.
