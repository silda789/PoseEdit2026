...
description: Per-file breakdown of what each core class in PoseEdit2026 does (Commands.cs, PoseEditWindow, AppSettings.cs, BlockHelper.cs, RebarRecognizer.cs, LayerCreator.cs, QuantityTableGenerator.cs, PozHelper.cs, LegacyCommands.cs). Use when navigating the codebase, figuring out which file/class handles something, or before adding new functionality.
---
